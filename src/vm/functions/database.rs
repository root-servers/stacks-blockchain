...
pub fn special_contract_call(
    ...
    runtime_cost(ClarityCostFunction::ContractCall, env, InputSize::None)?;
...
pub fn special_at_block(
    ...
    runtime_cost(ClarityCostFunction::AtBlock, env, InputSize::None)?;
...
pub fn special_get_block_info(
    ...
    runtime_cost(ClarityCostFunction::BlockInfo, env, InputSize::None)?;
